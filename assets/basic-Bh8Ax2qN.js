import{u as k,n as z,A as T,O as N,h as R,e as _,a as qe,v as d,E as O,R as E,r as B,D as Ot,U as me,z as he,V as xn,t as j,x as ae,T as $t,d as Oe,M as Gt,X as Yt,Y as Jt,l as Qt,L as Pe,C as de,Z as En,_ as Rn,K as Mt,G as Xt,$ as vt}from"./core-QOIOqsze.js";import{n as u,r as C,c as S,o as A,U as oe,i as _n,t as Tn,e as Sn}from"./index-D8TEQCP3.js";import{d as In}from"./dijkstra-D_NXgYpA.js";import"./index-C_PYXIkN.js";import"./Buy-CafoFoQ0.js";import"./index.browser.esm-CqQTMj2l.js";import"./index-BTJb-n1K.js";import"./bytes-CjWw8TJh.js";import"./arrival-HEYkqz28.js";import"./curve-B1ptH__1.js";var Ae=function(e,t,n,o){var r=arguments.length,i=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,o);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(r<3?s(i):r>3?s(t,n,i):s(t,n))||i);return r>3&&i&&Object.defineProperty(t,n,i),i};let we=class extends k{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=z.state.connectors,this.count=T.state.count,this.filteredCount=T.state.filteredWallets.length,this.isFetchingRecommendedWallets=T.state.isFetchingRecommendedWallets,this.unsubscribe.push(z.subscribeKey("connectors",t=>this.connectors=t),T.subscribeKey("count",t=>this.count=t),T.subscribeKey("filteredWallets",t=>this.filteredCount=t.length),T.subscribeKey("isFetchingRecommendedWallets",t=>this.isFetchingRecommendedWallets=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){const t=this.connectors.find(c=>c.id==="walletConnect"),{allWallets:n}=N.state;if(!t||n==="HIDE"||n==="ONLY_MOBILE"&&!R.isMobile())return null;const o=T.state.featured.length,r=this.count+o,i=r<10?r:Math.floor(r/10)*10,s=this.filteredCount>0?this.filteredCount:i;let a=`${s}`;this.filteredCount>0?a=`${this.filteredCount}`:s<r&&(a=`${s}+`);const l=_.hasAnyConnection(qe.CONNECTOR_ID.WALLET_CONNECT);return d`
      <wui-list-wallet
        name="Search Wallet"
        walletIcon="search"
        showAllWallets
...
`;var le=function(e,t,n,o){var r=arguments.length,i=r<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,n):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,n,o);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(i=(r<3?s(i):r>3?s(t,n,i):s(t,n))||i);return r>3&&i&&Object.defineProperty(t,n,i),i};let G=class extends k{constructor(){super(),this.unsubscribe=[],this.connectors=z.state.connectors,this.recommended=T.state.recommended,this.featured=T.state.featured,this.explorerWallets=T.state.explorerWallets,this.connections=_.state.connections,this.connectorImages=Ot.state.connectorImages,this.loadingTelegram=!1,this.unsubscribe.push(z.subscribeKey("connectors",t=>this.connectors=t),_.subscribeKey("connections",t=>this.connections=t),Ot.subscribeKey("connectorImages",t=>this.connectorImages=t),T.subscribeKey("recommended",t=>this.recommended=t),T.subscribeKey("featured",t=>this.featured=t),T.subscribeKey("explorerFilteredWallets",t=>{this.explorerWallets=t!=null&&t.length?t:T.state.explorerWallets}),T.subscribeKey("explorerWallets",t=>{var n;(n=this.explorerWallets)!=null&&n.length||(this.explorerWallets=t)})),R.isTelegram()&&R.isIos()&&(this.loadingTelegram=!_.state.wcUri,this.unsubscribe.push(_.subscribeKey("wcUri",t=>this.loadingTelegram=!t)))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return d`
