...
`,ee=S.span`
  ...
  color: var(--privy-color-foreground);
`;export{Oe as AwaitingPasswordlessCodeScreen,fe as AwaitingPasswordlessCodeScreenView,Oe as default};
