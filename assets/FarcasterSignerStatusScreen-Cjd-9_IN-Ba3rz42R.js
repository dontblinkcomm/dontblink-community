import{d7 as u,d8 as t}from"./index-hvr-UNpG.js";import{h as F,j as T,l as I,F as w,J as y,as as B,B as O,g as n}from"./Buy-BPnFS-iq.js";import{h as _}from"./CopyToClipboard-i_OQSBJr-qYYmLeyO.js";import{n as q}from"./OpenLink-CUpJ1mOr-CVf1XatH.js";import{x as E}from"./QrCode-CpGkVlXb-DRXdA1JV.js";import{n as A}from"./ScreenLayout-DTsWfKKs-DGvB6Ikl.js";import{l as h}from"./farcaster-DPlSjvF5-C-lA_srZ.js";import"./index.browser.esm-L30Cv8Cp.js";import"./index-BTJb-n1K.js";import"./bytes-CjWw8TJh.js";import"./arrival-BJtY1EL_.js";import"./curve-D0zgMnZL.js";import"./dijkstra-D_NXgYpA.js";import"./ModalFooter-DKyozrEX-BKsjLYrC.js";import"./Screen-DMmH56yL-DthyRLwR.js";import"./index-CWARkn2w-8Gwg1QrC.js";let S="#8a63d2";const M=({appName:p,loading:m,success:i,errorMessage:e,connectUri:r,onBack:s,onClose:c,onOpenFarcaster:o})=>t.jsx(A,y||m?B?{title:e?e.message:"Add a signer to Farcaster",subtitle:e?e.detail:`This will allow ${p} to add casts, likes, follows, and more on your behalf.`,icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},primaryCta:r&&o?{label:"Open Farcaster app",onClick:o}:void 0,onBack:s,onClose:c,watermark:!0}:{title:e?e.message:"Requesting signer from Farcaster",subtitle:e?e.detail:"This should only take a moment",icon:h,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!e},onBack:s,onClose:c,watermark:!0,children:r&&y&&t.jsx(R,{children:t.jsx(q,{text:"Take me to Farcaster",url:r,color:S})})}:{title:"Add a signer to Farcaster",subtitle:`This will allow ${p} to add casts, likes, follows, and more on your behalf.`,onBack:s,onClose:c,watermark:!0,children:t.jsxs(L,{children:[t.jsx(N,{children:r?t.jsx(E,{url:r,size:275,squareLogoElement:h}):t.jsx(z,{children:t.jsx(O,{})})}),t.jsxs(P,{children:[t.jsx(V,{children:"Or copy this link and paste it into a phone browser to open the Farcaster app."}),r&&t.jsx(_,{text:r,itemName:"link",color:S})]})]})});let R=n.div`
  margin-top: 24px;
`,L=n.div`
  display: flex;
